...
html{{background:var(--bg);color:var(--text);font-family:var(--font-sans);font-size:14px;line-height:1.5}}
...
.article-header:hover .article-title{{color:#fff}}
.article-meta{{
...
.trade-field b{{color:#aaa;font-weight:500}}
.trade-quant{{
